...
#
#update_by      :Bill Doerr
#update_version :1.2.1
#update_date    :18Apr2021	
#==============================================================================
...
# Changed by Bill Doerr. Make call to python script to shutdown slave nodes and master node
# sudo halt
python3 /usr/local/bin/juice4halt.py
